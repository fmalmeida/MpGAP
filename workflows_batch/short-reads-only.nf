...
// SPAdes sreads
include { spades } from '../modules_batch/ShortReads/spades_sreads.nf'

// Unicycler sreads
include { unicycler } from '../modules_batch/ShortReads/unicycler_sreads.nf'

// Shovill sreads
include { shovill } from '../modules_batch/ShortReads/shovill_sreads.nf'

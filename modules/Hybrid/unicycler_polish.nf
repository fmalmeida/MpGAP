process pilon_polish {
  ...
  if(params.shortreads_paired != '')
  ...
  else if(params.shortreads_paired == '')
      """
      # Create the results dir
      mkdir pilon_results_${assembler};
      ...
      --genome ${draft} --bam ${id}_${assembler}_aln.bam --output ${assembler}_final_polish.fasta \
      --outdir pilon_results_${assembler} &>pilon.log

      # save bam file in the desired directory
      mv ${id}_${assembler}_aln.bam pilon_results_${assembler};
      """
}
